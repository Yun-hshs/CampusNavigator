...
void SearchBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->resultSelected((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SearchBar::*)(const QString & )>(_a, &SearchBar::searchRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SearchBar::*)(int )>(_a, &SearchBar::resultSelected, 1))
            return;
    }
}
...
// SIGNAL 1
void SearchBar::resultSelected(int _t1)
{
