...
#include "../../../src/business/usercontroller.h"
...
void UserController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->favoritesChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (UserController::*)(const QString & )>(_a, &UserController::loginSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserController::*)(const QString & )>(_a, &UserController::loginFailed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserController::*)(const QString & )>(_a, &UserController::registerSuccess, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserController::*)(const QString & )>(_a, &UserController::registerFailed, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserController::*)()>(_a, &UserController::favoritesChanged, 4))
            return;
    }
}
...
// SIGNAL 0
void UserController::loginSuccess(const QString & _t1)
{
...
// SIGNAL 2
void UserController::registerSuccess(const QString & _t1)
{
...
// SIGNAL 4
void UserController::favoritesChanged()
{
